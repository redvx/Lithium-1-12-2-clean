...
public class ImgurScreenshotThread
extends Thread
implements Minecraftable {
    ...
    public void run() {
        try {
            ...
            mc.addScheduledTask(() -> ImgurScreenshotThread.sendMessage(stringSelection, string2));
        }
    ...
    private static void sendMessage(StringSelection stringSelection, String string) {
        ...
        Logger.getLogger().log("\u00a7bImage uploaded to: " + string);
    }
}

...
import me.chachoox.lithium.impl.managers.client.CommandManager;
import me.chachoox.lithium.impl.managers.client.FontManager;
import me.chachoox.lithium.impl.managers.client.FriendManager;
import me.chachoox.lithium.impl.managers.client.ModuleManager;
import me.chachoox.lithium.impl.managers.client.ThreadManager;
...
public class Managers {
    ...
    public static void load() {
        ...
        Managers.subscribe(SPEED, COMMAND, TPS, DUMMY, ACTION, ROTATION, TIMER, SAFE, SWITCH, STOP, TOTEM, CRASH, KNOCKBACK, KEY, CONNECTION, CHAT);
        MODULE.init();
        COMMAND.init();

...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        GL20.glAttachShader((int)program, (int)this.createShader("/shaders/passthrough.vsh", GLSLSandboxShader.class.getResourceAsStream("/shaders/passthrough.vsh"), 35633));
        GL20.glAttachShader((int)program, (int)this.createShader(fragmentShaderLocation, GLSLSandboxShader.class.getResourceAsStream(fragmentShaderLocation), 35632));
